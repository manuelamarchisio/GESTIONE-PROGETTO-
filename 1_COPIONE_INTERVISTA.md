...
**DR.SSA MARTINELLI:** Esatto, siamo molto eccitate! Sarà un ospedale all'avanguardia, vogliamo il meglio per i nostri pazienti. Abbiamo bisogno di un sistema informatico moderno, efficiente... insomma, che funzioni bene.
...
**DR.SSA MARTINELLI:** Va bene, lo facciamo. Grazie per la pazienza! So di non essere molto ferrata in tecnologia, ma confido nelle vostre competenze.
...
**ING. ROSSI:** Partiamo dal sistema di prenotazione. Chi sono gli **attori principali** coinvolti nel processo di prenotazione?
...
**ING. ROSSI:** Giusto! Servono:
- Dati del paziente (nome, cognome, codice fiscale, tessera sanitaria)
- Tipo di visita richiesta (specialità medica)
- Data e ora desiderate (o disponibilità)
- Eventuale priorità/urgenza

E dove vengono **memorizzate** queste informazioni? Abbiamo bisogno di alcuni **archivi dati**...

**[PAUSA - I ragazzi rispondono]**

**ING. ROSSI:** Esattamente! Ci servono:
- **Archivio Pazienti** (anagrafica)
- **Archivio Prenotazioni** (agenda)
- **Archivio Medici** (disponibilità, specialità)

Ora disegniamo insieme il **processo**. *(disegna alla lavagna/proietta)*

<img src="schemi/DFD-P1-PrenotazioneVisite.svg" alt="DFD - Sistema di Prenotazione Visite" width="100%" />
...
**ING. ROSSI:** Giusto! Il sistema deve:
- Inviare una **conferma al paziente** (email, SMS)
- Aggiornare l'**agenda del medico**
- Registrare la prenotazione nell'archivio

E se il paziente vuole **modificare o cancellare**? Serve un altro processo?

**[PAUSA - I ragazzi rispondono]**

**ING. ROSSI:** *(completa il diagramma)* Esattamente, aggiungiamo:

<img src="schemi/DFD-P2-ModificaPrenotazione.svg" alt="P2: Modifica o Cancellazione Prenotazione" width="100%" />
...
**ING. ROSSI:** Esatto! Contiene:
- **Anagrafica paziente** (già abbiamo questo archivio)
- **Anamnesi** (storia clinica, allergie, patologie pregresse)
- **Visite** (data, medico, diagnosi, terapie prescritte)
- **Esami** (laboratorio, radiologia con referti)
- **Prescrizioni** (farmaci, dosaggi)
- **Ricoveri** (se il paziente è stato ricoverato)

Ora, quali sono i **processi principali**? Cosa fa il medico con la cartella?
...
- Il medico/infermiere legge le informazioni
- Input: Codice Paziente
- Output: Dati clinici visualizzati

**P4: Aggiorna Cartella**
- Il medico/infermiere aggiunge nuove informazioni (visita, esame, ecc.)
- Input: Nuovi dati clinici
- Output: Cartella aggiornata

Disegniamo:

<img src="schemi/DFD-P3P4-CartellaClinica.svg" alt="DFD - Cartella Clinica Elettronica" width="100%" />
...
<img src="schemi/DFD-P5-Autenticazione.svg" alt="P5: Autenticazione e Autorizzazione" width="100%" />

---

### INTEGRAZIONE TRA I DUE SISTEMI

**ING. ROSSI:** Ora una domanda importante: questi due sistemi - **Prenotazioni** e **Cartella Clinica** - devono comunicare tra loro?
...
**ING. ROSSI:** Giusto! Ci sono almeno due momenti:

1. **All'accettazione**: Il paziente si presenta, il sistema conferma la prenotazione e apre/crea la cartella
2. **Durante la visita**: Il medico accede alla cartella del paziente prenotato

Serve un processo che li colleghi:

<img src="schemi/DFD-P6-Accettazione.svg" alt="P6: Gestisci Accettazione - Integrazione Prenotazioni e Cartella Clinica" width="100%" />

---

### DOMANDE DI APPROFONDIMENTO

**ING. ROSSI:** Ora ragazzi, pensate a queste criticità:

**1. Cosa succede se due medici cercano di modificare la stessa cartella contemporaneamente?**

**[PAUSA - I ragazzi rispondono]**

**ING. ROSSI:** Esatto, serve un **meccanismo di lock** o **gestione della concorrenza**! Il sistema deve prevenire conflitti.
...
**ING. ROSSI:** Significa che il processo P4 deve **propagare immediatamente** le modifiche a tutti gli utenti che stanno consultando quella cartella. Serve un meccanismo di **notifica/refresh**.
...
### ARCHIVI DATI E RELAZIONI

**ING. ROSSI:** Ultimo punto importante. Abbiamo identificato diversi archivi dati:
...
Come sono **collegati** tra loro? Un paziente nelle Prenotazioni è lo stesso paziente nella Cartella?
...
**DR.SSA MARTINELLI:** *(un po' confusa ma impressionata)* Wow, non pensavo fosse così complesso! Ma adesso vedo meglio come funziona tutto insieme.
